			...
			<div className="section-center featured-center">
				<article className="tour-card">
					<div className="tour-img-container">
						<img src={tourImageOne} className="tour-img" alt="" />
				...
				<article className="tour-card">
					<div className="tour-img-container">
						<img src={tourImageTwo} className="tour-img" alt="" />
				...
				<article className="tour-card">
					<div className="tour-img-container">
						<img src={tourImageThree} className="tour-img" alt="" />
				...
				<article className="tour-card">
					<div className="tour-img-container">
						<img src={tourImageFour} className="tour-img" alt="" />
